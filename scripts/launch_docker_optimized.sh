...
docker build -f docker/Dockerfile.optimized -t nexus-app:optimized ../NEXUS_app/backend/

# Stop any existing containers
echo "🛑 Stopping existing containers..."
docker-compose -f docker/docker-compose.optimized.yml down --remove-orphans || true
...
echo "  View logs:           docker-compose -f docker/docker-compose.optimized.yml logs -f"
echo "  Stop services:       docker-compose -f docker/docker-compose.optimized.yml down"
echo "  Restart services:    docker-compose -f docker/docker-compose.optimized.yml restart"
echo "  Scale app:           docker-compose -f docker/docker-compose.optimized.yml up -d --scale nexus-app=3"
echo ""
